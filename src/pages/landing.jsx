	...
	const handleDownload = (e) => {
		...
		fetch('resume.pdf').then(response => {
			response.blob().then(blob => {
				...
				alink.href = fileURL;
				alink.download = 'Lazarus Gabriel.pdf';
				alink.click();
			})
		})
	}
			...
			<div className="text-gray-300 h-full	">
				<div className="flex sm:md:flex-row flex-col items-center mt-28 lg:mt-0 justify-between h-full">
					<div className="sm:md:w-1/2 flex items-center">
						<div className="">
							<h1 className="text-3xl font-bold">Hello!, I'm Lazarus <span className="text-main">Gabriel</span>.<br/> <span className="gradient-text">A Frontend Web Developer</span></h1>
							...
							<div className="flex flex-row my-4">
								<h2 className="px-2 py-1 text-xs bg-[#515151aa] rounded w-fit mr-2">Tailwind</h2>
								<h2 className="px-2 py-1 text-xs bg-[#515151aa] rounded w-fit mr-2">JavaScript</h2>
