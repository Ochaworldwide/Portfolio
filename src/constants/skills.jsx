...
const skills = {
  backend: [
    {
      name: "NodeJS",
      icon: <FaNodeJs className="text-3xl mr-2" />,
    ...
    {
      name: "MongoDB",
      icon: <SiMongodb className="text-3xl mr-2" />,
    ...
    {
      name: "PHP",
      icon: <FaPhp className="text-3xl mr-2" />,
    ...
    {
      name: "Laravel",
      icon: <FaLaravel className="text-3xl mr-2" />,
    ...
    {
      name: "MySQL",
      icon: <SiMysql className="text-3xl mr-2" />,
  ...
  frontend: [
    {
      name: "HTML",
      icon: <FaHtml5 className="text-3xl mr-2" />,
    ...
    {
      name: "CSS",
      icon: <FaCss3 className="text-3xl mr-2" />,
    ...
    {
      name: "React",
      icon: <FaReact className="text-3xl mr-2" />,
    ...
    {
      name: "Javascript",
      icon: <SiJavascript className="text-3xl mr-2" />,
    ...
    {
      name: "TailwindCSS",
      icon: <SiTailwindcss className="text-3xl mr-2" />,
    ...
    {
      name: "Github Actions",
      icon: <SiGithubactions className="text-3xl mr-2" />,
      text: "GitHub Actions is a CI/CD (Continuous Integration/Continuous Deployment) platform that allows developers to automate their build, test, and deployment pipelines",
    },
  ],
};
